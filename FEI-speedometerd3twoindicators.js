...
define(["jquery",
        "text!./FEI-speedometerd3twoindicators.css",
        "text!./googleplay.css",
        "./d3.min",
        "./iopctrl",
        "./pointergestures",
...
var vizwithref = function(data,labels,layout,width,height,id) {
    ...
    for(i=0; i<document.styleSheets.length; i++){  
        if(document.styleSheets[i].ownerNode.innerHTML.substring(0,73) == ".qv-object-FEI-speedometerd3twoindicators div.qv-object-content-container"){ 
    ...
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeunder .indicator', newColorStroke.concat(layout.colorOfUnder,";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .segdisplayunder .on', newColorFill.concat(layout.colorOfUnder,";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeover .indicator', newColorStroke.concat(layout.colorOfOver,";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .segdisplayover .on', newColorFill.concat(layout.colorOfOver,";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeover .arc, .qv-object-FEI-speedometerd3twoindicators .gaugeover .cursor', newOpacity.concat((layout.arcOpacity/2),";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeunder .arc, .qv-object-FEI-speedometerd3twoindicators .gaugeunder .cursor', newOpacity.concat((layout.arcOpacity/2),";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeref .arc, .qv-object-FEI-speedometerd3twoindicators .gaugeref .cursor', newOpacity.concat((layout.arcOpacity/2),";"));
    ...
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeover .major', newFontSize.concat(fontPercentage,";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeunder .major', newFontSize.concat(fontPercentage,";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeref .major', newFontSize.concat(fontPercentage,";"));
...
var vizwithoutref = function(data,labels,layout,width,height,id) {
    ...
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeunder .indicator', newColorStroke.concat(layout.colorOfUnder,";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .segdisplayunder .on', newColorFill.concat(layout.colorOfUnder,";"));
    speedometerSheet.addRule('.qv-object-FEI-speedometerd3twoindicators .gaugeunder .arc, .qv-object-FEI-speedometerd3twoindicators .gaugeunder .cursor', newOpacity.concat((layout.arcOpacity),";"));
